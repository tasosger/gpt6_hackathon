...
import { ArrowLeft, ArrowRight, Check, ChevronLeft, ChevronRight, Clock3, Download, Expand, Eye, Globe2, LockKeyhole, Mic, Pause, Play, RotateCcw, ScanLine, Share2, Sparkles, Volume2, VolumeX, X } from "lucide-react";
