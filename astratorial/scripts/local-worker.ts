...
async function main() {
  if(process.env.ASTRATORIAL_LOCAL_WORKER!=="1")throw new Error("Set ASTRATORIAL_LOCAL_WORKER=1 to use illustrated local generation. Do not run it alongside the measured cloud worker.");
